...
import com.niponnumb.lotproject.event.UiToastEvent;
import com.niponnumb.lotproject.helper.EnhancedSharedPreferences;
import com.niponnumb.lotproject.helper.NotificationHelper;
import com.niponnumb.lotproject.service.MyBluetoothSerialService;
import com.niponnumb.lotproject.util.Config;
import com.niponnumb.lotproject.util.Constants;
...
public class PanelActivity extends AppCompatActivity {
    ...
    private MyServiceMessageHandler myServiceMessageHandler;
    ...
    private ImageView imgUp, imgDown, imgLight, imgLeft, imgRight, imgStop, imgConnect, imgSound;

    static String UP = "e";
    static String DOWN = "a";
    static String LEFT = "i";
    static String RIGHT = "d";
    static String AUTOMATIC = "l";
    static String STOP = "0";
    static String CLACSON = "p";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
         ...
         * MESSAGE_TOAST
         */
        myServiceMessageHandler = new MyServiceMessageHandler(this, this);
    ...
    private void inicializarControles() {
        ...
        imgConnect.setOnClickListener(v -> {
            if(bluetoothAdapter.isEnabled()){
        ...
        imgUp.setOnClickListener(v -> {
            if(myBluetoothSerialService != null && myBluetoothSerialService.getState() == MyBluetoothSerialService.STATE_CONNECTED){
                ...
                Config.Mensaje(PanelActivity.this, "Debe conectar su bluetooth joven", false, false);
            }
        });
        ...
        imgSound.setOnClickListener(v -> {
            if(myBluetoothSerialService != null && myBluetoothSerialService.getState() == MyBluetoothSerialService.STATE_CONNECTED){
                myBluetoothSerialService.serialWriteString(CLACSON); // Enviamos la data a nuestro arduino
            }else{
                Config.Mensaje(PanelActivity.this, "Debe conectar su bluetooth joven", false, false);
            }
        });
